...
(function () {
  ...
  var css = '#gate{position:fixed;inset:0;z-index:400;background:#f6efe3;display:flex;align-items:center;justify-content:center;visibility:visible;text-align:center;padding:24px}' +
    ...
    '#gate .k{font-size:.74rem;font-weight:700;letter-spacing:.26em;text-transform:uppercase;color:#9c3a26;margin-bottom:12px}' +
    ...
    '#gate input:focus{outline:none;border-color:#9c3a26}' +
    '#gate .err{color:#9c3a26;font-size:.85rem;font-weight:600;min-height:22px;margin-top:8px}' +
    '#gate button{width:100%;margin-top:4px;background:#9c3a26;color:#fbf6ec;border:none;border-radius:8px;padding:14px;font-weight:600;font-size:.88rem;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;font-family:inherit}' +
    '#gate button:hover{background:#83301f}' +
